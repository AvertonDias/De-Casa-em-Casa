...
export const createCongregationAndAdminV2 = https.onRequest((req: Request, res: Response) => {
...
export const notifyOnNewUserV2 = https.onRequest((req: Request, res: Response) => {
    corsHandler(req, res, async () => {
        try {
...
export const requestPasswordResetV2 = https.onRequest((req: Request, res: Response) => {
    corsHandler(req, res, async () => {
        try {
...
export const resetPasswordWithTokenV2 = https.onRequest((req: Request, res: Response) => {
    corsHandler(req, res, async () => {
        try {
...
export const deleteUserAccountV2 = https.onRequest((req: Request, res: Response) => {
    corsHandler(req, res, async () => {
        try {
