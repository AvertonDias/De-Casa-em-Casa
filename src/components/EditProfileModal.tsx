            ...
            <div className="flex justify-end gap-4 mt-6">
              {success ? (
                <Dialog.Close asChild>
                  <button type="button" className="px-4 py-2 bg-gray-200 dark:bg-gray-600 text-gray-800 dark:text-white rounded hover:bg-gray-300 dark:hover:bg-gray-500">Fechar</button>
                </Dialog.Close>
              ) : (
                <>
                  <Dialog.Close asChild>
