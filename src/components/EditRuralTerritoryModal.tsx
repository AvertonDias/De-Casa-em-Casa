...
import { Trash2, Edit, Loader, Plus, Link as LinkIcon, Save, FileText } from 'lucide-react';
  ...
  return (
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="sm:max-w-lg">
          ...
          <form id="edit-rural-form" onSubmit={handleSubmit} className="space-y-4 py-4 px-1">
            ...
            <div className="border-t border-border pt-4 space-y-3">
              <div className="flex items-center justify-between">
                  ...
                  <a href="https://drive.google.com/file/d/1Ssoluk4MgZ3yt30d58o_wxIVpnrE-RSf/view?usp=drivesdk" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-[10px] font-black uppercase text-orange-600 dark:text-orange-400 hover:underline">
                      <FileText size={12} />
                      Sugestão: Cartão Rural
                  </a>
              </div>
