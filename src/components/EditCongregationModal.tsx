  ...
  return (
    <Dialog.Root open={isOpen} onOpenChange={setIsOpen}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed top-16 left-1/2 w-[90vw] max-w-lg -translate-x-1/2 rounded-lg bg-white dark:bg-[#2f2b3a] p-6 shadow-lg focus:outline-none max-h-[90vh] overflow-y-auto md:top-1/2 md:-translate-y-1/2">
