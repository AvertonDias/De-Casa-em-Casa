          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4">
                <div className="w-1/2">
                  ...
                  <input 
                    ...
                    className="w-full bg-input rounded-md p-2 border border-border focus:outline-none focus:ring-2 focus:ring-primary disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                  />
                ...
                <div className="w-1/2">
                  ...
                  <input 
                    ...
                    className="w-full bg-input rounded-md p-2 border border-border focus:outline-none focus:ring-2 focus:ring-primary text-sm"
                  />
                </div>
              </div>
              ...
              {!isReassigning && (
                <div>
                  ...
                  <select 
                    ...
                    className="w-full bg-input rounded-md p-2 border border-border text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary text-sm"
              ...
              <div className="flex justify-end space-x-3 pt-4 border-t border-border mt-4">
                ...
                <button onClick={handleSave} className="px-4 py-2 rounded-md bg-primary text-primary-foreground hover:bg-primary/80 text-sm font-medium">Salvar Designação</button>
              </div>
            </div>
          </motion.div>
        </motion.div>
