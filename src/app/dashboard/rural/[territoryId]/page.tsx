        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
              ...
              {isAdmin && user.congregationId && territory && (
                <button onClick={() => setIsEditTerritoryModalOpen(true)} className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-md flex items-center justify-center">
