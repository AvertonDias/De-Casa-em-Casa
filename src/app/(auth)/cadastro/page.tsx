...
export default function SignUpPage() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
        ...
        if (congSnap.empty) {
            throw new Error("Congregação não encontrada com este número.");
        }
        ...
        <div className="w-full max-w-sm p-8 space-y-6 bg-card text-card-foreground rounded-xl shadow-lg">
          ...
          <form onSubmit={handleSignUp} className="space-y-4">
              ...
              <div className="relative">
                <input type={showPassword ? "text" : "password"} value={password} onChange={handleInputChange(setPassword)} placeholder="Senha (mín. 6 caracteres)" required className="w-full px-4 py-2 bg-background border border-input rounded-md pr-10" autoComplete="new-password" />
              ...
              <div className="relative">
                <input type={showConfirmPassword ? "text" : "password"} value={confirmPassword} onChange={handleInputChange(setConfirmPassword)} placeholder="Confirme sua Senha" required className="w-full px-4 py-2 bg-background border border-input rounded-md pr-10" autoComplete="new-password" />
              ...
              <input type="tel" inputMode="numeric" value={congregationNumber} onChange={handleInputChange(setCongregationNumber)} placeholder="Número da Congregação" required className="w-full px-4 py-2 bg-background border border-input rounded-md" />
