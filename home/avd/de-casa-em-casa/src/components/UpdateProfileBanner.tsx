...
export function UpdateProfileBanner({ onUpdateProfileClick }: { onUpdateProfileClick: () => void }) {
  ...
  return (
    <div className="p-4 bg-blue-100 border border-l-4 border-blue-400 rounded-lg dark:bg-blue-900/30 dark:border-blue-500/60 dark:border-l-blue-500 flex items-start justify-between gap-4">
